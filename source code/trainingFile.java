...
public class trainingFile {
    ...
    public static void main(String args[]) throws IOException, FileNotFoundException, Exception{
        ...
        ob.annot = new File(args[1]);
        
        
        Scanner scr = new Scanner(ob.text);
        Scanner scnr1 = new Scanner(ob.annot);
        String fLine = "";
        String fLine1 = "";
        int lineNumber = 1;
    ...
    public void feat12() throws FileNotFoundException{
        ...
        File list = new File("C:\\Users\\DIPANAKR\\Desktop\\Satanu\\MS-FIRE\\Language Lexicon\\smileyList.txt");
    ...
    public void NEdetection() throws Exception {
        ...
        String serializedClassifier = "stanford-ner-2015-04-20\\stanford-ner-2015-04-20\\classifiers\\english.all.3class.distsim.crf.ser.gz";
    ...
    public boolean isFound(String fileName, String word) throws FileNotFoundException{
        ...
        File srch = new File("Language Lexicon\\"+fileName+".txt");
    ...
    public void writeFile() throws FileNotFoundException, IOException{
         ...
         File file = new File("CRF++-0.58\\CRF++-0.58\\CRF_Training.txt");
